...
if __name__=="__main__":
    ...
    parser.add_argument('--dp', type=str, default="data/raw/vice_data_for_test_task.csv", help="Path to data")
    parser.add_argument('--on', type=str, default="data/output/vice_data_with_signal_category.csv", help="Name to save processed data as")
    ...
    important_columns = ['Post Created', 'Video Share Status', 'Total Views', 
                     ...
                     'Care']
    file_name = args.dp
    outputname = format_outfile_name(args.on)
